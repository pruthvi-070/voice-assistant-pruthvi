...
def main():
    ...
    respond("Hello, Pruthvi.  Whatsup bud   Miss  Me   What Can I Do For U .")
    while True:
        command = listen_for_command()

        triggerKeyword = "prithvi"
        ...
        if command and triggerKeyword in command:
            if listeningToTask:
                ...
                webbrowser.open("https://img.freepik.com/free-vector/realistic-hand-drawn-fuck-you-symbol_23-2148684365.jpg?semt=ais_hybrid&w=740&q=80")
            elif "open linkedin" in command:
                respond("Opening Linkedin.")
                webbrowser.open("https://www.linkedin.com/in/pruthviraj-gadugale/")
